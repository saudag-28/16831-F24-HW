...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        random_indice = np.random.permutation(self.obs.shape[0])[-batch_size:] # pbs.shape[0] = total number of data points

        return (
          self.obs[random_indice],
          self.acs[random_indice],
          self.rews[random_indice],
          self.next_obs[random_indice],
          self.terminals[random_indice]
        )
