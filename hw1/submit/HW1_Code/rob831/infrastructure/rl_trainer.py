...
class RL_Trainer(object):
    ...
    def collect_training_trajectories(
        ...
        if (itr == 0):
          with open(load_initial_expertdata, 'rb') as f:
            ...
            num_trajectories = len(loaded_paths)
            print(f'Number of trajectories of expert: {num_trajectories}')
          return loaded_paths, 0, None

        # (2) collect `self.params['batch_size']` transitions - state 1 to state 2
    ...
    def perform_logging(self, itr, paths, eval_policy, train_video_paths, training_logs):
        ...
        num_trajectories_agent = len(eval_paths)
        print(f'Number of trajectories of bc_agent: {num_trajectories_agent}')
