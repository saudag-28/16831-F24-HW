...
# Optional function to save logs to file (if you want)
def save_logs(self, logs):
    # Assuming you want to save logs to a file for later reference
...
def main():
    ...
    parser.add_argument('--eval_batch_size', type=int,
                        default=1000)  # eval data collected (in the env) for logging metrics - should be 5*times for 2)
