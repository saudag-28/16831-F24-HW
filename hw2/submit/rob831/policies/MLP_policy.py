...
class MLPPolicyPG(MLPPolicy):
    ...
    def update(self, observations, actions, advantages, q_values=None):
        ...
        if self.nn_baseline:
            ...
            # raise NotImplementedError
            q_norm = normalize(q_values, np.mean(q_values), np.std(q_values))
            ...
            # Compute baseline loss (mean squared error between baseline and Q-values)
            baseline_loss = self.baseline_loss(baseline_predictions, q_norm)

            # Backpropagate the baseline loss
