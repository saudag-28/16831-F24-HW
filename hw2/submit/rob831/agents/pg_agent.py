...
class PGAgent(BaseAgent):
    ...
    def estimate_advantage(self, obs, rewards_list, q_values, terminals):
        ...
        if self.nn_baseline:
            ...
            # raise NotImplementedError
            # Ensure baseline predictions have the same mean and std as current Q-values
            ...
            if self.gae_lambda is not None:
                ...
                # raise NotImplementedError
                # Compute advantage as Q-values minus baseline values
    ...
    def _discounted_cumsum(self, rewards):
        ...
        discounted_cumsums /= discounts_t
